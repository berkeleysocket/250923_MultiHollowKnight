namespace Ksy.Agent.Module.HealthSystem
{
    ...
    {
        public DamageData(Entity giver, AttackType attackType, DamageFlag damageFlag, int damageValue)
        {
            this.giver = giver;
        ...
        public static DamageData Create(Entity giver, AttackType attackType, DamageFlag damageFlag, int damageValue)
        {
